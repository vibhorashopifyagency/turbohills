<?php
    ...
    $data = [
        ...
        "inspiration_details" => [
            ...
            "sections" => [
                ["id" => "scenic-viewpoints", "title" => "1. Scenic Viewpoints", "description" => "These viewpoint halts match top search intent such as best Zuluk zig-zag road views, Thambi-like sunrise frames and dramatic Old Silk Route panoramas.", "images" => [["src" => "/assets/img/sikkim/Kupup-Lake-Zuluk-edited.webp", "alt" => "Viewpoint", "col" => 7], ["src" => "/assets/img/sikkim/zulluk.webp", "alt" => "Mountains", "col" => 5]]],
                ["id" => "culture-heritage", "title" => "2. Culture & Heritage", "description" => "Old trade-route stories and mountain community life answer AEO-style questions about Zuluk history, Silk Route relevance and local cultural context.", "image" => ["src" => "/assets/img/sikkim/zuluk-silk-route-tour-500x500.webp", "alt" => "Culture"], "tags" => ["title" => "Popular around Zuluk", "items" => [["label" => "Viewpoints", "url" => "#scenic-viewpoints"], ["label" => "Route Heritage", "url" => "#culture-heritage"], ["label" => "Mountain Routes", "url" => "#short-scenic-drives"], ["label" => "Zuluk", "url" => (strtok($_SERVER['REQUEST_URI'] ?? '', '?') ?: '#')]]]],
                ["id" => "short-scenic-drives", "title" => "3. Short Scenic Drives", "description" => "Drive-and-stop planning along dramatic bends keeps Zuluk suitable for couples and families seeking scenic but manageable East Sikkim road experiences.", "image" => ["src" => "/assets/img/sikkim/zulukloops.jpg", "alt" => "Scenic drive"]]
            ],
