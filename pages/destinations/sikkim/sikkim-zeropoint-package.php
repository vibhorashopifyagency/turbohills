    ...
    $data = [
        ...
        "inspiration_details" => [
            ...
            "sections" => [
                ...
                [
                    ...
                    "tags" => [
                        ...
                        "items" => [
                                ...
                                ["label" => "Snowline Stops", "url" => "#culture-heritage"], 
                                ["label" => "Mountain Routes", "url" => "#short-scenic-drives"], 
                                ["label" => "Zero Point", "url" => (strtok($_SERVER['REQUEST_URI'] ?? '', '?') ?: '#')]
                            ]
                        ]
                ],
                [
                ...
                [
                    "label" => "Sikkim", 
                    "url" => "/pages/destinations/sikkim/sikkim-experiences.php"
                ]
            ]
        ],
