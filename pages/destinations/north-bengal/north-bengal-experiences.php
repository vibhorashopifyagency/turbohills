            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <img src="<?= BASE_URL ?>/assets/img/innerpages/sikkim-himalayan-mountains.jpg"
                        alt="Himalayan mountain landscape in North Bengal near Darjeeling and Kalimpong"
                        loading="eager"
                        fetchpriority="high"
                        decoding="async">
                </div>
                ...
                <div class="swiper-slide">
                    <img src="<?= BASE_URL ?>/assets/img/innerpages/sikkim-buddhist-monastery.jpg"
                        alt="Hillside monastery and mountain scenery in North Bengal travel circuit"
                        loading="lazy"
                        decoding="async">
                </div>
                ...
                <div class="swiper-slide">
                    <img src="<?= BASE_URL ?>/assets/img/innerpages/sikkim-scenic-valley.jpg"
                        alt="Scenic valley view in North Bengal with forests, tea gardens, and winding roads"
                        loading="lazy"
                        decoding="async">
                </div>
                ...
                <div class="swiper-slide">
                    <img src="<?= BASE_URL ?>/assets/img/innerpages/sikkim-snow-road.jpg"
                        alt="Mountain road in North Bengal hill region during winter season"
                        loading="lazy"
                        decoding="async">
                </div>
                ...
                <div class="swiper-slide">
                    <img src="<?= BASE_URL ?>/assets/img/innerpages/sikkim-mountain-village.jpg"
                        alt="Traditional mountain village in North Bengal with hillside homes"
                        loading="lazy"
                        decoding="async">
                </div>
            ...
            <div class="row justify-content-center mb-60 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms"> 
                <div class="col-lg-10">
                    <div class="destination-details-content">
                        <h2>North Bengal Travel Experiences - Darjeeling, Dooars, Kalimpong & More</h2>
                        <p><strong>Updated:</strong> February 2026 | Prepared by the TurboHills local operations team for travelers planning from Bagdogra and NJP.</p>
                        <ul class="destination-info">
                            ...
                            <li>
                                <div class="content">
                                    <span>Language -</span> English, Hindi, Bengali, Nepali, and regional hill dialects
                                </div>
                                <div class="info">
                                    ...
                                    <div class="tooltip-text">Bengali, Nepali, Hindi, and English are commonly spoken across North Bengal tourist hubs.</div>
                                </div>
                            </li>
                        </ul>
                        <p>North Bengal is one of India’s most diverse mountain-and-forest destinations, blending tea gardens, Himalayan viewpoints, heritage hill towns, riverside villages, and wildlife landscapes. Popular circuits include <a href="<?= BASE_URL ?>/pages/destinations/north-bengal/darjeeling.php">Darjeeling</a>, <a href="<?= BASE_URL ?>/pages/destinations/north-bengal/mirik.php">Mirik</a>, <a href="<?= BASE_URL ?>/pages/destinations/north-bengal/kurseong.php">Kurseong</a>, <a href="<?= BASE_URL ?>/pages/destinations/north-bengal/lava.php">Lava</a>, and <a href="<?= BASE_URL ?>/pages/destinations/north-bengal/lolegaon.php">Lolegaon</a>.</p>
                        <p>At TurboHills, we design personalized North Bengal tour packages from Bagdogra Airport and NJP Railway Station with reliable transport, handpicked stays, and local support. We also plan offbeat routes such as <a href="<?= BASE_URL ?>/pages/destinations/north-bengal/takdah.php">Takdah</a>, <a href="<?= BASE_URL ?>/pages/destinations/north-bengal/rishyap.php">Rishyap</a>, <a href="<?= BASE_URL ?>/pages/destinations/north-bengal/latpanchar.php">Latpanchar</a>, and <a href="<?= BASE_URL ?>/pages/destinations/north-bengal/suntalekhola.php">Suntalekhola</a> for travelers seeking quieter experiences.</p>
                            ...
                            <div class="swiper-slide">
                                <div class="location-card">
                                    <div class="location-img">
                                        <img src="<?= BASE_URL ?>/assets/img/innerpages/destination-dt-location-img1.jpg" alt="Darjeeling town with Himalayan views in North Bengal" loading="lazy">
                                    </div>
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Darjeeling - Queen of the Hills</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    <div class="location-img">
                                        <img src="<?= BASE_URL ?>/assets/img/innerpages/destination-dt-location-img2.jpg" alt="Mirik Lake and pine forest landscape in North Bengal" loading="lazy">
                                    </div>
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Mirik - Lake & Pine Forests</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    <div class="location-img">
                                        <img src="<?= BASE_URL ?>/assets/img/innerpages/destination-dt-location-img3.jpg" alt="Kurseong tea garden views in North Bengal hills" loading="lazy">
                                    </div>
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Kurseong - Tea & Toy Train Charm</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    <div class="location-img">
                                        <img src="<?= BASE_URL ?>/assets/img/innerpages/destination-dt-location-img4.jpg" alt="Lava and Lolegaon pine forest trails in North Bengal" loading="lazy">
                                    </div>
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Lava & Lolegaon - Forest Retreats</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    <div class="location-img">
                                        <img src="<?= BASE_URL ?>/assets/img/innerpages/destination-dt-location-img5.jpg" alt="Sandakphu and Phalut trekking range views from North Bengal" loading="lazy">
                                    </div>
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Sandakphu & Phalut - Trekking Highlights</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    <div class="location-img">
                                        <img src="<?= BASE_URL ?>/assets/img/innerpages/destination-dt-location-img6.jpg" alt="Samsing and Suntalekhola riverside nature escapes in North Bengal" loading="lazy">
                                    </div>
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Samsing & Suntalekhola - Nature Escapes</a></h6>
                                    </div>
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="location-card">
                                    <div class="location-img">
                                        <img src="<?= BASE_URL ?>/assets/img/innerpages/destination-dt-location-img7.jpg" alt="Jhalong and Buxa landscape near North Bengal foothills" loading="lazy">
                                    </div>
                                    <div class="location-content">
                                        <h6><a href="https://www.google.com/maps">Jhalong & Buxa - River and Foothill Trails</a></h6>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <p>From tea-garden viewpoints to forest-edge villages, our North Bengal travel experiences are built with strong local knowledge. TurboHills plans practical routes, quality stays, experienced drivers, and realistic day-wise pacing for smooth, comfortable holidays.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <p>We keep pricing clear and honest. Our North Bengal tour packages include detailed cost breakdowns with no hidden charges. From cab services and accommodation to sightseeing planning, you know exactly what you are paying for before your trip begins.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="why-choose-card">
                        ...
                        <h4>24/7 Support</h4>
                        <p>Travel confidently with 24/7 support from TurboHills during your North Bengal trip. Whether you need route help, weather advice, or last-minute schedule adjustments, our team stays available before and during the journey.</p>
                    </div>
                </div>
            </div>
            <ul>
                <li>Customized North Bengal Tour Itineraries</li>
                <li>Bagdogra & NJP Pickup and Drop</li>
                <li>Experienced Local Drivers & Route Planning</li>
            ...
            <div class="row g-4">
                    ...
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="<?= BASE_URL ?>/assets/img/innerpages/travel-season-img1.jpg" alt="North Bengal tea gardens and mountain views in spring" loading="lazy">
                            </div>
                            <div class="travel-season-content">
                                <h5>Spring (March-May)</h5>
                                <p>Spring is one of the best times to visit North Bengal. Pleasant weather, blooming hills, and clear mountain views make it ideal for Darjeeling sightseeing, tea-estate visits, and relaxed family trips.</p>
                                ...
                                <div class="highlights-area">
                                    ...
                                    <ul>
                                        <li>
                                            ...
                                            Blooming hills and vibrant landscapes
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                        ...
                                        <li>
                                            ...
                                            Ideal weather for sightseeing and local excursions
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Best for sightseeing, couples, and families</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="<?= BASE_URL ?>/assets/img/innerpages/travel-season-img2.jpg" alt="North Bengal monsoon greenery with misty hills" loading="lazy">
                            </div>
                            <div class="travel-season-content">
                                <h5>Summer (June-August)</h5>
                                <p>Summer and monsoon bring rich greenery and mist-covered hill landscapes across North Bengal. This season is great for travelers seeking peaceful stays, scenic drives, and fewer crowds.</p>
                        ...
                        <span class="note">Budget travelers and slow travel lovers</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="<?= BASE_URL ?>/assets/img/innerpages/travel-season-img3.jpg" alt="Autumn Himalayan views from North Bengal hills" loading="lazy">
                            </div>
                            <div class="travel-season-content">
                                <h5>Autumn (Sep to Nov)</h5>
                                <p>Autumn offers the clearest Kanchenjunga views and is peak season for North Bengal tourism. Perfect for Darjeeling, Kurseong, Mirik, Lava, and adventure routes like Sandakphu-Phalut.</p>
                                ...
                                <div class="highlights-area">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            Peak season for North Bengal holidays
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                        ...
                        <span class="note">Adventure seekers and photographers</span>
                    </div>
                </div>
                <div class="col-lg-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                    <div class="travel-season-card">
                        <div class="travel-season-top-area">
                            <div class="travel-season-img">
                                <img src="<?= BASE_URL ?>/assets/img/innerpages/travel-season-img4.jpg" alt="Winter mountain landscape in North Bengal" loading="lazy">
                            </div>
                            <div class="travel-season-content">
                                <h5>Winter (Dec to Feb)</h5>
                                <p>Winter in North Bengal is crisp, scenic, and perfect for clear skyline views, tea-town stays, and cozy hill holidays. Higher routes can be chilly, making it a favorite season for romantic and slow-paced trips.</p>
                                <span>Weather: 2-12°C / 36-54°F</span>
                                <div class="highlights-area">
                                    <h6>Highlights:</h6>
                                    <ul>
                                        <li>
                                            ...
                                            Crisp weather and clear mountain horizons
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Cozy hill stays in Darjeeling and nearby towns
                                        </li>
                                        <li>
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <rect width="16" height="16" rx="8"/>
                                            ...
                                            Quieter travel season with fewer tourist rushes
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        <span class="note">Couples, photographers, and winter travelers</span>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="faq-area">
                <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                    <div class="col-xl-6 col-lg-8">
                        <div class="section-title text-center">
                            <h2>North Bengal Travel FAQs</h2>
                            ...
                            <div class="accordion accordion-flush" id="accordionFlushExample">
                                <div class="accordion-item wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                                    ...
                                    <div id="flush-collapseOne" class="accordion-collapse collapse show"
                                        ...
                                        <div class="accordion-body">
                                            <span>Darjeeling, Mirik, Kurseong, Lava, Lolegaon, Sandakphu, Phalut, Samsing, Suntalekhola, and Jhalong-Buxa</span> are among the top places to visit in North Bengal. Each offers a different travel style, from tea-estate views and hill heritage to trekking routes and nature escapes.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                                    <h5 class="accordion-header" id="flush-headingTwo">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            aria-expanded="false" aria-controls="flush-collapseTwo">How many days are ideal for a North Bengal trip?</button>
                                    </h5>
                                    <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                        aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body">
                                        A <span>4 to 7 day North Bengal itinerary</span> is ideal for most travelers. Short trips can cover Darjeeling and Mirik, while longer plans include Kalimpong-side villages, Lava-Lolegaon, and offbeat locations like Rishyap, Takdah, and Latpanchar.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                                    ...
                                    <div id="flush-collapseThree" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                        The best time to visit North Bengal is <span>March to May</span> and <span>September to November</span> for pleasant weather and clear views. Monsoon is great for greenery, while winter is excellent for peaceful hill stays and scenic mountain skylines.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                                    ...
                                    <div id="flush-collapseFour" class="accordion-collapse collapse"
                                        ...
                                        <div class="accordion-body">
                                            <span>Yes, TurboHills specializes</span> in personalized North Bengal tour packages based on your <span>travel style, budget, and duration.</span> We customize routes, hotels, and local experiences for couples, families, groups, and offbeat explorers.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow animate fadeInDown" data-wow-delay="900ms" data-wow-duration="1500ms">
                                    <h5 class="accordion-header" id="flush-headingFive">
                                        <button class="accordion-button collapsed" type="button"
                                            ...
                                            aria-expanded="false" aria-controls="flush-collapseFive">How do I reach North Bengal from Bagdogra Airport or NJP?</button>
                                    </h5>
                                    <div id="flush-collapseFive" class="accordion-collapse collapse"
                                        aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body">
                                            Most North Bengal itineraries start from <span>Bagdogra Airport (IXB)</span> or <span>NJP Railway Station</span>. TurboHills arranges airport and station pickup, transfer cabs, and day-wise route planning for smooth travel.
                                        </div>
                                    </div>
                                </div>
                                <div class="accordion-item wow animate fadeInDown" data-wow-delay="1000ms" data-wow-duration="1500ms">
                                    <h5 class="accordion-header" id="flush-headingSix">
                                        <button class="accordion-button collapsed" type="button"
                                            data-bs-toggle="collapse" data-bs-target="#flush-collapseSix"
                                            aria-expanded="false" aria-controls="flush-collapseSix">Is North Bengal suitable for family and senior citizen travel?</button>
                                    </h5>
                                    <div id="flush-collapseSix" class="accordion-collapse collapse"
                                        aria-labelledby="flush-headingSix" data-bs-parent="#accordionFlushExample">
                                        <div class="accordion-body">
                                            Yes. We create family-friendly itineraries with balanced drive times, comfortable hotels, and relaxed sightseeing. For senior travelers, we prioritize easier routes, fewer hotel changes, and practical support throughout the trip.
                                        </div>
                                    </div>
                                </div>
                            </div>
