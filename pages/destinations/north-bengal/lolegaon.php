<?php
    ...
    $data = [
        ...
        "additional_info" => [
            "title" => 'Travel Notes',
            "items" => [
                [ 'highlight' => 'Suitability', 'description' => 'Lolegaon is a popular offbeat choice for low-traffic trails, short hikes and cozy homestays, especially for couples and families seeking quiet mountain stays.' ],
                [ 'highlight' => 'Best Time', 'description' => 'Oct–Dec is preferred for clearer ridge views, while Mar–May is ideal for fresh forest color and pleasant weather for short outdoor walks.' ]
            ]
        ],
        "faq" => [
            "title" => 'FAQ',
