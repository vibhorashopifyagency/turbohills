                ...
                <div class="tab-pane fade <?= ($tab_id === 'pills-europe') ? 'show active' : '' ?>" id="<?= $tab_id ?>" role="tabpanel" aria-labelledby="<?= $tab_id ?>-tab">
                    <div class="row gy-md-5 gy-4">
                        <?php foreach ($destinations as $index => $destination): ?>
                            ...
                            $image_path = $destination['image'] ?? $destination_grid_default_images[$index % count($destination_grid_default_images)];
            ...
            <div class="tab-pane fade show active" id="pills-europe" role="tabpanel" aria-labelledby="pills-europe-tab">
                <div class="row gy-md-5 gy-4">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div class="destination-card">
                            <a href="destination-details.html" class="destination-img">
                                <img src="assets/img/innerpages/destination-img1.jpg" alt="">
                            </a>
                            <div class="destination-content">
                                <a href="destination-details.html" class="title-area">
                                    <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="content">
                                    <p>125 tours | 220 departure 15,786 guest travelled.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="destination-card">
                            <a href="destination-details.html" class="destination-img">
                                <img src="assets/img/innerpages/destination-img2.jpg" alt="">
                            </a>
                            <div class="destination-content">
                                <a href="destination-details.html" class="title-area">
                                    <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="content">
                                    <p>130 tours | 200 departure 15,786 guest travelled.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="destination-card">
                            <a href="destination-details.html" class="destination-img">
                                <img src="assets/img/innerpages/destination-img3.jpg" alt="">
                            </a>
                            <div class="destination-content">
                                <a href="destination-details.html" class="title-area">
                                    <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="content">
                                    <p>120 tours | 240 departure 15,548 guest travelled.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
                        <div class="destination-card">
                            <a href="destination-details.html" class="destination-img">
                                <img src="assets/img/innerpages/destination-img4.jpg" alt="">
                            </a>
                            <div class="destination-content">
                                <a href="destination-details.html" class="title-area">
                                    <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="content">
                                    <p>150 tours | 240 departure 15,548 guest travelled.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="destination-card">
                            <a href="destination-details.html" class="destination-img">
                                <img src="assets/img/innerpages/destination-img5.jpg" alt="">
                            </a>
                            <div class="destination-content">
                                <a href="destination-details.html" class="title-area">
                                    <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="content">
                                    <p>130 tours | 270 departure 15,548 guest travelled.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
                        <div class="destination-card">
                            <a href="destination-details.html" class="destination-img">
                                <img src="assets/img/innerpages/destination-img6.jpg" alt="">
                            </a>
                            <div class="destination-content">
                                <a href="destination-details.html" class="title-area">
                                    <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
