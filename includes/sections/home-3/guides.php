<div class="home4-destination-section mb-100">
            ...
            <div class="row justify-content-center mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
                <div class="col-xl-6 col-lg-8">
                    <div class="section-title text-center">
                        <h2>Our Local Experts Guides</h2>
                    </div>
                </div>
            </div>
                ...
                <div class="swiper home3-destination-slider">
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="destination-card2 three">
                                <div class="destination-img">
                                    <img src="<?= BASE_URL ?>/assets/img/guides/guide1.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                        ...
                        <div class="swiper-slide">
                            <div class="destination-card2 three">
                                <div class="destination-img">
                                    <img src="<?= BASE_URL ?>/assets/img/guides/guide3.jpg" alt="">
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide">
                        ...
                        <div class="swiper-slide">
                            <div class="destination-card2 three">
                                <div class="destination-img">
                                    <img src="<?= BASE_URL ?>/assets/img/guides/guide5.jpg" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <img src="<?= BASE_URL ?>/assets/img/home4/vector/destination-section-vector.svg" alt="" class="vector">
    </div>