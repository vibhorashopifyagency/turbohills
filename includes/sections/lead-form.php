    ...
    <div class="container">
        ...
        <div class="filter-input-wrap">
            <form id="booking-form" class="filter-input show" action="#" onsubmit="return false;">
                ...
                <button id="booking-button" type="button" class="primary-btn1">
                    <span>
                        <?php echo $search_svg; ?>
                        BOOK NOW
                    </span>
            ...
            <p>Can't find what you're looking for? create your <a href="contact.php">Custom Itinerary</a></p>
        </div>
    </div>
</div>
...
<script>
    (function(){
        ...
        const whatsappNumber = '917029019681'; // change to your WhatsApp number (country code, no +)
